...
const es = {
  ...
  home: {
    prodTituloA: 'Tu ticketera.',
    prodTituloB: 'Vos cobrás',
    prodTituloC: 'el ',
    prodTituloD: '.',
    prodBajada:
    ...
    compradorTituloC: 'en vivo.',
    compradorBajada:
      'Comprá sin crearte cuenta. Te mandamos el QR al mail y con ese mismo mail después ves tus entradas en Mis Tickets.',
    ...
    vacioTexto: 'Estamos abriendo la cartelera. Si producís, publicá el tuyo y sos de los primeros.',
    vacioCta: 'Publicar mi evento',
    seguridadKicker: 'Seguridad Absoluta',
    seguridadTituloA: 'Tu entrada es tuya.',
    seguridadTituloB: 'Y de nadie más.',
    seguridadTexto:
    ...
    qrUnico: 'QR ÚNICO',
    escenaKicker: 'Nuestra Escena',
    escenaTitulo: 'Donde querés estar.',
...
const en: typeof es = {
  ...
  home: {
    prodTituloA: 'Your ticketing.',
    prodTituloB: 'You keep',
    prodTituloC: '',
    prodTituloD: ' of it.',
    prodBajada:
    ...
    compradorTituloC: 'experiences.',
    compradorBajada:
      'Buy without creating an account. We email you the QR code, and with that same email you can find your tickets under My Tickets.',
    ...
    vacioTexto: 'We’re opening up the listings. If you produce events, publish yours and be among the first.',
    vacioCta: 'Publish my event',
    seguridadKicker: 'Airtight Security',
    seguridadTituloA: 'Your ticket is yours.',
    seguridadTituloB: 'And no one else’s.',
    seguridadTexto:
      'A unique QR code that cannot be cloned. If you can’t make it, you pass it on to a friend officially through the platform: your old code stops existing instantly and a new one is issued to whoever receives it. At the door, the one who gets in is you.',
    qrUnico: 'UNIQUE QR',
    escenaKicker: 'Our Scene',
    escenaTitulo: 'Where you want to be.',
