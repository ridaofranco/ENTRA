...
const es = {
  ...
  evento: {
    ...
    comprar: 'Comprar',
    reservar: 'Reservar',
    entradasElegidas: (n: number) => `${n} ${n === 1 ? 'entrada' : 'entradas'}`,
    elegiEntradas: 'Elegí tus entradas',
  ...
  checkout: {
    ...
    emailInvalido: 'Revisá tu email: ahí te mandamos las entradas.',
...
const en: typeof es = {
  ...
  evento: {
    ...
    comprar: 'Buy',
    reservar: 'Reserve',
    entradasElegidas: (n: number) => `${n} ${n === 1 ? 'ticket' : 'tickets'}`,
    elegiEntradas: 'Pick your tickets',
  ...
  checkout: {
    ...
    emailInvalido: 'Check your email address: that is where we send the tickets.',
